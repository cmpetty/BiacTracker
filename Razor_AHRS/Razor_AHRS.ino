...
// SENSOR CALIBRATION // CP calibration numbers 9/9/14
/*****************************************************************/
// How to calibrate? Read the tutorial at http://dev.qu.tu-berlin.de/projects/sf-razor-9dof-ahrs
// Put MIN/MAX and OFFSET readings for your board here!
// Accelerometer
// "accel x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX" default +/- 250
#define ACCEL_X_MIN ((float) -280)
#define ACCEL_X_MAX ((float) 253)
#define ACCEL_Y_MIN ((float) -249)
#define ACCEL_Y_MAX ((float) 270)
#define ACCEL_Z_MIN ((float) -263)
#define ACCEL_Z_MAX ((float) 287)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -149)
#define MAGN_X_MAX ((float) 367)
#define MAGN_Y_MIN ((float) -137)
#define MAGN_Y_MAX ((float) 414)
#define MAGN_Z_MIN ((float) -271)
#define MAGN_Z_MAX ((float) 240)
...
#define GYRO_AVERAGE_OFFSET_X ((float) 1.04)
#define GYRO_AVERAGE_OFFSET_Y ((float) 0.97)
#define GYRO_AVERAGE_OFFSET_Z ((float) 1.23)

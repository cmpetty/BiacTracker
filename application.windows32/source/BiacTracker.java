...
public class BiacTracker extends PApplet {
...
int warnColor = 0xffC0392B;
public float slideVal = 8.0f;
...
//vals for plot
int xPos = 1;
float lastY = 0.0f, lastP = 0.0f, lastR = 0.0f;
...
public void slideVal(float degreeVal){
  println(degreeVal);
}

//turn on/off the alerts
public void alert(boolean togFlag){
  doAlert = (togFlag==true) ? true : false;
}

//turn on/off the leveling
public void level(boolean togFlag){
  doLevel = (togFlag==true) ? true : false;
}

//turn on/off the vlc control
public void pause(boolean togFlag){
...
public void vlc_control(String url) {
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "BiacTracker" };
    if (passedArgs != null) {
